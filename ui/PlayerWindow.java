...
public class PlayerWindow extends JFrame {
    ...
    private BufferedImage chooseAvatar(int playerID) throws IOException{
        ...
        switch (playerID) {
            case 100:
                image = ImageIO.read(new File("resource/gotcha.png"));
                break;
            case 200:
                image = ImageIO.read(new File("resource/sportsman.png"));
                break;
            case 300:
                image = ImageIO.read(new File("resource/motor.png"));
                break;
            case 400:
                image = ImageIO.read(new File("resource/blackman.png"));
                break;
            case 500:
                image = ImageIO.read(new File("resource/girl.png"));
                break;
        }
        return image;
    }
